    ...
    input.addEventListener("input", (e) => {
      ...
      if (e.target.type === "text") {
        ...
        if (inputText.length > 2) {
          ...
          colorize("#FE8C66", line, placeholder);
        }
      }
      //Validation email
...
const tl2 = gsap.timeline({
  defaults: { durations: 0.5, ease: 'Power2.easeOut' }
});
...
gsap.fromTo('#eyebrow', {y:0}, {y:-2, repeat: -1, yoyo: true, repeatDelay: 0.5, ease: 'Power2.easeOut'})
